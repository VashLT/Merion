            ...
            <div className="lab-content">
                ...
                <section id="biblio">
                    ...
                    <p className="mb-1"><strong>2.</strong>
                        ...
                        <a target="_blank" rel="noreferrer" href="https://latam.university/que-es-la-transformacion-digital/?gclid=Cj0KCQjw6-SDBhCMARIsAGbI7UiOPyNkGOSmJLqw19s25GkkhaL0oj0x0Xxgf5oXBf8b3QZ142XCK1MaAjuTEALw_wcB" title="Transformacion digital - LATAM UNIVERSITY">
                            Libro
                        </a>
                    </p>
