...
function getLabPreviewHTML(lab, index) {
    ...
    return (
        // <div className="card" onClick={document.getElementById('t' + index).click()} id="labItem">
        <div className="card" id="labItem">
            <div className="card-header d-flex flex-row justify-content-between clicky align-items-center" id={'h' + index}>
            ...
            <div id="collapseOne" className="collapse show" aria-labelledby={'h' + index} data-parent="#accordion">
