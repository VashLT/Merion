        ...
        <div className="lab" id="firstLab">
            ...
            <div className="lab-content mt-2">
                ...
                <div className="list-group list-group-flush mb-4">
                    ...
                    <a href="#Qt2" className="list-group-item list-group-item-action" >
                        ¿Qué situaciones "cotidianas" encuentra hoy en día en las máquinas de cómputo
                        que prevalecen desde los primeros días de esas primeras máquinas de computación?
                    </a>
                    <a href="#Qt3" className="list-group-item list-group-item-action">
                        Compare las principales características de su teléfono celular o del PC que tiene
                        junto a usted al momento de hacer este informe (capacidad de memoria,
                        almacenamiento, consumo energético, capacidad de procesamiento e incluso
                        complejidad), con las de esas máquinas pioneras. ¿Cuáles han sido los cambios
                        más dramáticos?.
                    </a>
                    <a href="#Qt4" className="list-group-item list-group-item-action" >
                        Hoy en día se habla mucho de la cuarta revolución industrial y la
                        transformación digital. ¿Qué es cada una de ellas? . Suponiendo que se
                        gradúa mañana ¿Tiene claro (o no) cómo hacer parte de esas transformaciones?
                    </a>
                    <a href="#Qt5" className="list-group-item list-group-item-action" >
                        En este momento hay una discusión entre expertos que afirman que
                        actualmente la pandemia aceleró esa transformación digital y otros
                        dicen que ha sido todo lo contrario. Como grupo, ¿Cuál es su punto de vista?
                    </a>
                    <a href="#Qt6" className="list-group-item list-group-item-action" >
                        Al ver el recorrido histórico de la arquitectura y organización de
                        computadores (ver las diapositivas respectivas y la bibliografía)
                        ¿Cuál creen, para ustedes como grupo, que ha sido el aporte más significante
                        que ha influido en la computación actual?
                    </a>
                ...
                <h4 id="biblio">Bibliografia</h4>
                <div className="hbar"></div>
                <p className="mb-1"><strong>1.</strong>
                        BBC NEWS. (2016, 12 octubre),Valeria Perasso.BBC Mundo. Qué es la cuarta
                        revolución industrial (y por qué debería preocuparnos).
	                    https://www.bbc.com/mundo/noticias-37631834
                    </p>
                <p className="mb-1"><strong>2.</strong>
                        LATAM UNIVERSITY, Business, Transformacion digital. ¿Qué es la
                        transformación digital?.
                        <a target="_blank" href="https://latam.university/que-es-la-transformacion-digital/?gclid=Cj0KCQjw6-SDBhCMARIsAGbI7UiOPyNkGOSmJLqw19s25GkkhaL0oj0x0Xxgf5oXBf8b3QZ142XCK1MaAjuTEALw_wcB" >
                        Libro
                        </a>
                </p>

                <p className="mb-1"><strong>3.</strong>
                        UNESCO. (2020, 10 27). Investment in education for recovery. Education is
                        not a cost, it’s investment for recovery, 1.
                        https://en.unesco.org/news/education-not-cost-its-investment-recovery
                    </p>

                <p className="mb-1"><strong>4.</strong>
                        PDP-11 de Digital Equipment Corp. (2010, 29 noviembre). Historia de la Informática.
                        https://histinf.blogs.upv.es/2010/11/29/pdp-11-de-digital-equipment-corp/
                    </p>

                <p className="mb-1"><strong>5.</strong>
                        Jaimes, C. (s. f.). Computer History. Wiki Supercomputación y Cálculo Científico. Recuperado 16 de abril de 2021, de
                        http://wiki.sc3.uis.edu.co/images/d/dd/CompHist1-16.pdf
                    </p>
